	...
	public MineswarmTeams(Plugin instance) {
		this.plugin = instance;
	      try {
	         ...
	         //"Can't serialize Player type.... fuck."//Options include:
	         //Use string everywhere I currently use Player, then convert
	         //Serialize entire class? (Although, I'd imageine if one peice cna't be serialized, none of it can)
